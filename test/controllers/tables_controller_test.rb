...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { number: @table.number, restaurant_id: @table.restaurant_id, state: @table.state }
    end
  ...
  test "should update table" do
    patch :update, id: @table, table: { number: @table.number, restaurant_id: @table.restaurant_id, state: @table.state }
    assert_redirected_to table_path(assigns(:table))
  end
