...
class MesasControllerTest < ActionController::TestCase
  ...
  test "should create mesa" do
    assert_difference('Mesa.count') do
      post :create, mesa: { estado: @mesa.estado, numero: @mesa.numero, restaurant_id: @mesa.restaurant_id }
    end
  ...
  test "should update mesa" do
    patch :update, id: @mesa, mesa: { estado: @mesa.estado, numero: @mesa.numero, restaurant_id: @mesa.restaurant_id }
    assert_redirected_to mesa_path(assigns(:mesa))
  end
