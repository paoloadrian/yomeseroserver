...
class MesasControllerTest < ActionController::TestCase
  ...
  test "should create mesa" do
    assert_difference('Mesa.count') do
      post :create, mesa: { number: @mesa.number, restaurant_id: @mesa.restaurant_id, state: @mesa.state }
    end
  ...
  test "should update mesa" do
    patch :update, id: @mesa, mesa: { number: @mesa.number, restaurant_id: @mesa.restaurant_id, state: @mesa.state }
    assert_redirected_to mesa_path(assigns(:mesa))
  end
