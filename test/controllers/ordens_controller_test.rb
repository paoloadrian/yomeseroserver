...
class OrdensControllerTest < ActionController::TestCase
  ...
  test "should create orden" do
    assert_difference('Orden.count') do
      post :create, orden: { consumo: @orden.consumo, estado: @orden.estado, mesa: @orden.mesa, rest: @orden.rest }
    end
  ...
  test "should update orden" do
    patch :update, id: @orden, orden: { consumo: @orden.consumo, estado: @orden.estado, mesa: @orden.mesa, rest: @orden.rest }
    assert_redirected_to orden_path(assigns(:orden))
  end
